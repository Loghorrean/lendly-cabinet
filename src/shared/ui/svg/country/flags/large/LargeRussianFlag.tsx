...
const LargeRussianFlag = ({ ...props }: CountrySvgProps) => {
    return (
        <CountrySvgContainer large>
            <CountrySvg {...props} large fill="none" xmlns="http://www.w3.org/2000/svg">
                <g clipPath="url(#clip0_1547_52727)">
                    <path d="M0.75 0.25H25.25V6.08333H0.75V0.25Z" fill="white" />
                    <path d="M0.75 6.08301H25.25V11.9163H0.75V6.08301Z" fill="#0039A6" />
                    <path d="M0.75 11.917H25.25V17.7503H0.75V11.917Z" fill="#D52B1E" />
                </g>
                <defs>
...
export default LargeRussianFlag;
