            ...
            <form onSubmit={handleSubmit} className={styles.borrower_form}>
                ...
                <div className={styles.borrower_form__inputs}>
                    <div className={styles.borrower_form__group}>
                        <CommonLabel htmlFor="inn">Наименование (ИНН)</CommonLabel>
                        <CommonInput id="inn">
                            <CommonInput.Container className={styles.borrower_form__input_container}>
                                <CommonInput.Input placeholder="Название компании или ИНН" />
                            </CommonInput.Container>
                        </CommonInput>
                    </div>
                    <div className={styles.borrower_form__group}>
                        <CommonLabel htmlFor="email">Электронная почта (логин)</CommonLabel>
                    ...
                    <div className={styles.borrower_form__group}>
                        <CommonLabel htmlFor="contact">Контактное лицо</CommonLabel>
                    ...
                    <div className={styles.borrower_form__group}>
                        <CommonLabel htmlFor="phone">Телефон</CommonLabel>
                    ...
                    <div className={styles.borrower_form__group}>
                        <CommonLabel htmlFor="money">Сумма займа</CommonLabel>
                    ...
                    <div className={styles.borrower_form__group}>
                        <CommonLabel htmlFor="type">Вид залога</CommonLabel>
                    ...
                    <div className={styles.borrower_form__group}>
                        <CommonLabel htmlFor="place">Местонахождение объекта</CommonLabel>
                    ...
                    <div className={styles.borrower_form__group}>
                        ...
                        <PasswordInput id="password">
                            <PasswordInput.Container className={styles.borrower_form__input_container}>
                ...
                <div className={styles.borrower_form__checkboxes}>
                    <Checkbox checked={infoAgreed} onChange={toggleInfo}>
                        Согласен на{" "}
                        <ExternalLink href="https://youtube.com" className={styles.borrower_form__external}>
